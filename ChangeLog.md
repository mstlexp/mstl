...
+ remove container -(mn_container.hpp) and netzwerk header file (mn_socket.hpp) from mn_mtSTL.hpp header file,
  when use then include it in your project manual, for socket support add after mtSTL.hpp the socket heaher file
  mn_socket.hpp and for container support after mtSTL.hpp the container header file mn_container.hpp
...
+ rename mn_base.hpp to mtSTL.hpp
